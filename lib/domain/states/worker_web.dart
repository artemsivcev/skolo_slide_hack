...
class BackgroundWorkerWeb implements BackgroundWorker {
  ...
  static String source = "importScripts(location.origin + '/worker.js');";
  ...
  @override
  void spawn(void Function(Map<String, dynamic>) entryPoint,
      {required String name,
      required void Function() onInitialized,
      required void Function(Map<String, dynamic> message) onFromWorker}) {
    assert(
      entryPoint != null,
    );
